...
<div class="bg-white text-black flex px-40 pt-10 border-t-2 border-gray-300">
	<div class="w-2/5 mr-10">
		<img alt="blb" class="w-3/12" src={BigLogBlack} />
		<div>
			PSSFB is an online platform that helps users to learn, practice coding skills and join the
