...
<div class="p-5 px-20 flex flex-wrap items-center pt-52 bg-blue-950">
	<div class="w-full font-light text-white text-2xl mb-5">
		Hello {$currentUser?.email??"Guest"}. Welcome you to PSSFB. Let's
		<span class="px-3 py-1 font-medium rounded-xl bg-white text-black">Start</span> to explore more!
	</div>
	{#if $currentUser}
		<div class="w-1/3">
			<div class="rounded-md flex flex-wrap items-center bg-white p-5 pb-10">
				<Avatar
					...
					classes="rounded-full border-neutral-400 border-2 w-1/4 mr-5"
				/>
