...
<div class="bg-neutral-100 py-40 flex text-black">
	<div
		class="w-1/5 rounded-r-none rounded-xl shadow-xl border border-neutral-300 p-5 bg-white min-h-screen"
	>
		...
		<div class="pl-5">
			...
			<div class="mb-5">
				...
				{#if $currentUser?.Role == 'Admin Bussiness'}
					...
					<a href="/manager/coursesmanager/addcourse" class="pl-3 hover:bg-neutral-100 block"
						>Add Course</a
					>
				{/if}
			</div>
			...
			<div>
				<a href="/manager/moderationposts" class="pl-3 hover:bg-neutral-100 block"
					>Moderation Posts</a
				>
	...
	<div
		class="w-4/5 text-black rounded-xl rounded-l-none shadow-xl border border-neutral-300 bg-white p-5"
	>
		<slot />
	</div>
</div>
